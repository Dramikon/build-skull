...
using BuildSkull;
using BuildSkull_UnitTests.MyToolWindowTest;

namespace BuildSkullTests.UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new BuildSkullPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(BuildSkull.GuidList.guidBuildSkullCmdSet, (int)BuildSkull.PkgCmdIDList.cmdidBuildSkull);
